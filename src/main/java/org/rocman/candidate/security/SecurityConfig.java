...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/register", "/api/auth/login", "/api/auth/verify", "/api/auth/resend-verification", "/api/auth/request-password-reset", "/api/auth/reset-password", "/error", "/api/hello").permitAll()
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(candidateDetailsService);
